                ...
                <form action="../Configuracion/DatosUsuario.php" method="POST">
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="Documento_Id" id="documentoId" class="form-control" placeholder="Documento de Identidad" required oninput="soloNumerosGuionesYPuntos(this)">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" name="Primer_Nombre" id="nombre" class="form-control" placeholder="Primer Nombre" required oninput="soloLetras(this)">
                        </div>
                        <div class="col">
                            <input type="text" name="Segundo_Nombre" id="segundoNombre" class="form-control" placeholder="Segundo Nombre" oninput="soloLetras(this)">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" name="Primer_Apellido" id="apellido" class="form-control" placeholder="Primer Apellido" required oninput="soloLetras(this)">
                        </div>
                        <div class="col">
                            <input type="text" name="Segundo_Apellido" id="segundoApellido" class="form-control" placeholder="Segundo Apellido" oninput="soloLetras(this)">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
